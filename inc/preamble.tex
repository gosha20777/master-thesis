...
\hypersetup{
    ...
    pdftitle={Доменная адаптация нейросетевого конвейера обработки изображений}
}
...
\titleformat{\section}{}{}{0.5mm}{\centering{\thesection\quad\MakeTextUppercase{#1}}\vspace{0.5em}}
\titleformat{\subsection}[block]{\vspace{0.5em}}{}{0.5mm}{\centering{\thesubsection\quad#1}\vspace{0.5em}}
\titleformat{\subsubsection}[block]{\vspace{0.5em}\normalsize}{}{0.5mm}{\centering{\thesubsubsection\quad#1}\vspace{0.5em}}
\titleformat{\paragraph}[block]{\normalsize}{}{0.5mm}{\centering{\MakeTextUppercase{#1}}}
